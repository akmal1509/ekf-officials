<template>
    <div class="fixed bottom-0 left-0 right-0 bg-white shadow-lg">
        <nav class="flex justify-around p-4 bottom-nav">
            ...
            <router-link
                to="/admin/dashboard"
                :class="{ isActive: isLinkActive('/admin/dashboard') }"
            >
            ...
            <router-link
                to="/admin/survey-sekolah"
                :class="{ isActive: isLinkActive('/admin/survey-sekolah') }"
            >
            ...
            <router-link
                to="/"
                :class="{ isActive: isLinkActive('/admin/canvas') }"
            >
