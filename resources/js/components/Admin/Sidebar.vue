...
<template>
    <div>
        ...
        >
            ...
            <hr
                class="h-px mt-0 bg-transparent via-black/40 bg-gradient-to-r from-transparent to-transparent mb-5"
            />
            <div class="space-y-5">
                <div class="">
                    <MenuSideBar
                ...
                <div class="">
                    <MenuSideBar
                        v-if="isAdmin"
                        link="/admin/penugasan-korcam"
                        text="Penugasan Korcam"
        ...
        return {
            dapilCategory: {
                ...
                list: [
                    ...
                    {
                        link: "/admin/dapil/wilayah-dapil",
                        text: "Wilayah dapil",
                    },
                ],
            },
