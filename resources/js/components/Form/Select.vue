<template>
    <div class="relative" ref="dropdownContainer">
        ...
        <ul
            ...
            class="absolute z-10 top-15 w-full border rounded bg-white shadow-lg"
        >
            <li class="p-2">
                <!-- <input
                    ref="inputSelected"
            ...
            <li
                ...
                :class="{ 'bg-gray-200': selectedItem === option.name }"
...
export default {
    ...
    methods: {
        ...
        selectOption(option) {
            ...
            this.$emit("update:search", option.id);
